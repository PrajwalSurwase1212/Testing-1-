...
protected:
    ...
    AP_OAPathPlanner::OA_RetState _oa_state = AP_OAPathPlanner::OA_RetState::OA_NOT_REQUIRED;    // state of object avoidance, if OA_SUCCESS we use _oa_destination to avoid obstacles
