...
private:
    ...
    bool flow_sum_is_rads{false};              // true if flow_sum holds values in rad/s, if false flow_sum holds dpi
    ...
    uint8_t sensor_id{0};                  // sensor_id received in latest mavlink message
