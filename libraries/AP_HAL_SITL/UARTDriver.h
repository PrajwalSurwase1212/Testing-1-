...
private:
    ...
    const char *_uart_path = nullptr;
    uint32_t _uart_baudrate = 0;
    ...
    SITL::SerialDevice *_sim_serial_device = nullptr;
    ...
    struct {
        ...
        bool loaded = false;  // true if data is all valid
        bool done_first_line = false;
        uint8_t terms_seen = 0;
        uint32_t first_timestamp_us = 0;
        uint32_t first_emit_micros_us = 0;
    } logic_async_csv;
