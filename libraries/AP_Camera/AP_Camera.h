...
public:
    ...
    void set_camera_information(uint8_t instance, const mavlink_camera_information_t &camera_info);

    void set_stream_information(const mavlink_video_stream_information_t &camera_info);
    void set_stream_information(uint8_t instance, const mavlink_video_stream_information_t &camera_info);
