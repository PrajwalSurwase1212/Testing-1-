...
def write_fullresults():
    ...
    results.addglob('APM:Copter documentation', 'docs/Kala/index.html')
...
if __name__ == "__main__":
    ...
    step_mapping = {
        ...
        "fly.KalaTests1a": "test.CopterTests1a",
        "fly.KalaTests1b": "test.CopterTests1b",
        "fly.KalaTests1c": "test.CopterTests1c",
        "fly.KalaTests1d": "test.CopterTests1d",
        "fly.KalaTests1e": "test.CopterTests1e",

        "fly.KalaTests2a": "test.CopterTests2a",
        "fly.KalaTests2b": "test.CopterTests2b",
